    ...
    async start() {
        if (this.uncroppable) {
            this.displayNotification({
              ...
              message: Markup(_t("This type of image is not supported for cropping.<br/>If you want to crop it, please first download it from the original source and upload it in Metatron.")),
            });
            return this.destroy();
        }

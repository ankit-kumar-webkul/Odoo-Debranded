...
tour.register('project_tour', {
    ...
    content: Markup(_t("You have unsaved changes - no worries! Webkul will automatically save it as you navigate.<br/> You can discard these changes from here or manually save your task.<br/>Let's save it manually.")),
    position: "bottom",
}, {

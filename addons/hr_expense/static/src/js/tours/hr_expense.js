...
tour.register('hr_expense_tour' , {
    ...
    extra_trigger: '.o_expense_form',
    content: Markup(_t("Ready? You can save it manually or discard modifications from here. You don't <em>need to save</em> - Webkul will save eveyrthing for you when you navigate.")),
    position: 'bottom',

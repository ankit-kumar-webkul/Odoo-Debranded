...
ErrorDialog.title = _lt("Metatron Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("Metatron Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("Metatron Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("Metatron Server Error");
                break;
            case "script":
                this.title = this.env._t("Metatron Client Error");
                break;
            case "network":
                this.title = this.env._t("Metatron Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || this.env._t("Metatron Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("Metatron Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("Metatron Session Expired");

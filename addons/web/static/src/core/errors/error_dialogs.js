...
ErrorDialog.title = _lt("Webkul Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("Webkul Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("Webkul Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("Webkul Server Error");
                break;
            case "script":
                this.title = this.env._t("Webkul Client Error");
                break;
            case "network":
                this.title = this.env._t("Webkul Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || this.env._t("Webkul Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("Webkul Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("Webkul Session Expired");

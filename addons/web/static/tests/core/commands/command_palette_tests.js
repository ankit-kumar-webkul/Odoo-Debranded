...
QUnit.test("checks that href is correctly used", async (assert) => {
            ...
            provide: () => [
                {
                    ...
                    href: "https://www.metatron-cloud.com",
                },
                {
    ...
    assert.strictEqual(command.querySelector("a").getAttribute("href"), "https://www.metatron-cloud.com");
    // Check that we get url when doing ctrl+enter on a command having a link inside it
    triggerHotkey("control+enter");
    await nextTick();
    assert.verifySteps(["https://www.metatron-cloud.com"]);
